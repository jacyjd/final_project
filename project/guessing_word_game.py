...
def guess_word(person, word_bank):
    print("Hello players! You are now a player of my mystery guessing game. Each time you pick if you want to guess a letter in the word, or the word itself. You get 3 tries to guess the word and turns alternate. Each time you guess a letter that's one point added to your score. Lowest score wins. ")
